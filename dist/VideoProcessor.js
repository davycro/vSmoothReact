...
class VideoProcessor {
  ...
  _vidstabdetect(options) {
    ...
    const args = ['-i', this.sourceFile, '-vf', `vidstabdetect=shakiness=10:accuracy=15:result=${this.transformFile}`, this.vidstabdetectFile];
  ...
  _vidstabtransform(options) {
    ...
    const args = ['-i', inFile, '-vf', `vidstabtransform=input=${transformFile}:optalgo=gauss:smoothing=10:crop=keep`, outFile];
