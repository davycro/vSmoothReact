...
class VideoProcessor {
  ...
  async build(options) {
    ...
    const vidstabdetectArgs = ['-i', inFile, '-vf', `vidstabdetect=shakiness=10:accuracy=15:result=${transformFile}`, vidstabdetectFile];
    const vidstabtransformArgs = ['-i', vidstabdetectFile, '-vf', `vidstabtransform=input=${transformFile}:optalgo=gauss:smoothing=10:crop=keep`, outFile];
